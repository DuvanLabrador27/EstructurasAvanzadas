    ...
    public static int [][] edge (int a){
      ...
      if(a==5){
        ...
        result = matriz;
                ...
                if(a==7){
        int [][] matriz = {{0,1},{1,2},{1,3},{3,4},{4,5}};
        result = matriz;
       
}
        else if(a==8){
        int [][] matriz  = {{0,1},{1,2},{1,3},{3,4},{3,5}};
        result = matriz;
    ...
    public void generarPruebas() {
        ...
        try {
            ...
            while (pc <= 20) {
                ...
                escritura.write("ID TEST" + pc + "//Test-" + a +"-Cantidad Nodos:" + sizetree(a) + "Arbol en Matriz:" + Arrays.deepToString(edge(a)) +  "\r\n");
        ...
        try {
            ...
            while (iterador  <= 20) {
               ...
               int test = Integer.parseInt(arraynumerica[1]);
                ...
                List <Integer> list = s.findMinHeightTrees(sizetree(test), edge(test));
